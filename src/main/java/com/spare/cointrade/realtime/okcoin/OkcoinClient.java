...
//    @PostConstruct
    public void startFetch(TradeType tradeType) {
...
//        String url = "wss://real.okex.com:10440/websocket/okexapi"; // OKEx合约
        ...
        WebSocketService service = new BuissnesWebSocketServiceImpl(tradeType);
...
//        client.addChannel("ok_sub_spot_eth_depth");
        client.addChannel("ok_sub_spot_eth_btc_depth");
    }
